...
const SPLENDY_PRODUCTS = [
  ...
  {
    id: "rosewood-ganesha-idol",
    name: "Rosewood Ganesha Idol",
    category: "Wooden Crafts",
    shortDescription: "Hand-chiseled rosewood Ganesha idol with intricate temple-style detailing.",
    longDescription: "Carved by hand from a single block of seasoned rosewood, this Ganesha idol draws on centuries-old temple carving traditions passed down through generations of artisan families. The deep relief work and fine detailing around the deity's form are entirely tool-worked — no molds, no shortcuts.",
    images: ["./ganesha.png", "./ganesha.png", "./ganesha.png"],
    material: "Solid seasoned rosewood, hand-finished with natural oil",
    dimensions: "Approx. 25cm (H) × 18cm (W) × 10cm (D) — sample spec, confirm per piece",
    color: "Deep reddish-brown natural rosewood tone with a hand-rubbed matte finish",
    craftsmanship: "Hand-chiseled by temple-town artisans using traditional relief-carving techniques, 50–70 hours of work per piece",
    care: "Dust with a soft dry cloth; keep away from direct sunlight and moisture; avoid chemical cleaners",
    availability: "Made to order — please inquire for current lead time"
  },
  {
    id: "pattachitra-radha-krishna",
    name: "Pattachitra Radha Krishna",
    category: "Wall Art",
    shortDescription: "Traditional Odisha scroll painting depicting Radha-Krishna, hand-painted with natural pigments.",
    longDescription: "This Pattachitra masterwork narrates the divine love of Radha and Krishna through the ancient scroll painting tradition of Odisha. Every line is drawn freehand with a fine squirrel-hair brush, and every color is mixed from natural, mineral, and vegetable sources — a technique unchanged for centuries.",
    images: ["./pattachitra.jpeg", "./pattachitra.jpeg", "./pattachitra.jpeg"],
    material: "Cotton canvas treated with tamarind paste and chalk powder base, natural pigments",
    dimensions: "Approx. 50cm × 35cm — sample spec, confirm per piece",
    color: "Rich earth tones — ochre, indigo, vermillion, and black outlines",
    craftsmanship: "Hand-painted freehand by artisans from Odisha's Raghurajpur heritage village",
    care: "Frame under glass to protect the natural pigments; avoid direct sunlight and humidity",
    availability: "Limited stock — please inquire for availability"
  },
  {
    ...
    name: "Bidriware Silver Vase",
    category: "Home Decor",
    shortDescription: "Tall blackened alloy vase with elaborate silver wire floral inlay, in the Bidriware tradition.",
    longDescription: "This tall-form Bidriware vase showcases the metal handicraft from Bidar, Karnataka, known for its striking contrast of jet-black alloy and gleaming silver inlay. Each vase is cast, engraved by hand, inlaid with pure silver wire, and then oxidized using a local soil mixture that gives the metal its signature deep black finish.",
    images: ["./vase.png", "./vase.png", "./vase.png"],
    material: "Zinc-copper alloy with pure silver inlay, oxidized finish",
    dimensions: "Approx. 30cm (H) × 14cm (dia.) — sample spec, confirm per piece",
    color: "Deep matte black with silver inlay detailing",
    craftsmanship: "Hand-engraved and inlaid by certified Bidriware artisans; oxidization uses a traditional soil-based process",
    care: "Wipe gently with a dry, soft cloth only; avoid water and polish to preserve the oxidized finish",
    availability: "In stock — please inquire for current availability"
  ...
  {
    id: "bidriware-wall-plate",
    name: "Bidriware Wall Plate",
    category: "Decorative Items",
    shortDescription: "Large ornamental Bidriware wall plate with geometric silver inlay patterns.",
    longDescription: "This large-format decorative wall plate carries the same Bidriware technique as our vases, reimagined as a bold statement piece. The geometric and floral inlay patterns are hand-marked and engraved before silver wire is meticulously hammered into each groove.",
    images: ["./plate.png", "./plate.png", "./plate.png"],
    material: "Zinc-copper alloy with pure silver inlay, oxidized finish",
    dimensions: "Approx. 25cm diameter — sample spec, confirm per piece",
    color: "Deep matte black with silver inlay detailing",
    craftsmanship: "Hand-engraved and inlaid by certified Bidriware artisans from Bidar, Karnataka",
    care: "Wipe gently with a dry, soft cloth only; avoid water and polish to preserve the oxidized finish",
    availability: "Made to order — please inquire for current lead time"
  ...
  {
    id: "antique-brass-lamp",
    name: "Antique Brass Lamp",
    category: "Lighting",
    shortDescription: "Hand-finished brass-toned ceremonial lamp with old-world royal court aesthetics.",
    longDescription: "This ceremonial lamp is designed as a statement centerpiece, drawing on royal court aesthetics and temple lighting traditions. The form is cast and finished by hand to give each piece a subtly one-of-a-kind character, bringing warmth and old-world grandeur to any room.",
    images: ["./lamp.png", "./lamp.png", "./lamp.png"],
    material: "Cast metal with a hand-applied antique brass-tone finish",
    dimensions: "Approx. 40cm (H) × 18cm (dia.) — sample spec, confirm per piece",
    color: "Antique gold / brass tone",
    craftsmanship: "Cast and hand-finished by metal artisans; each piece hand-polished individually",
    care: "Dust regularly with a dry cloth; avoid abrasive cleaners on the finish",
    availability: "In stock — please inquire for current availability"
  },
  {
    ...
    category: "Wall Art",
    shortDescription: "Vibrant Tree of Life folk painting from Bihar, hand-painted in bold natural colors.",
    longDescription: "This Madhubani masterpiece depicts the sacred Tree of Life motif from the Mithila region of Bihar. Traditionally created by women artists using twigs, brushes, and matchsticks in place of formal tools, the bold outlines and nature-inspired motifs — birds, fish, the sun, the lotus — carry deep symbolic meaning within the tradition.",
    images: ["./madhubani.jpeg", "./madhubani.jpeg", "./madhubani.jpeg"],
    material: "Handmade paper or cloth base with natural and vegetable dyes",
    dimensions: "Approx. 50cm × 40cm — sample spec, confirm per piece",
    color: "Vibrant multicolor with bold black outlines",
    craftsmanship: "Hand-painted freehand by Mithila-region folk artists",
    care: "Frame under glass; keep away from direct sunlight and moisture",
    availability: "Limited stock — please inquire for availability"
